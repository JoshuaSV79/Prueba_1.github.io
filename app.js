...
function mostrarSeccion(seccion, btn) {
    ...
    // Activar el botón correspondiente (se espera el botón como segundo parámetro)
...
// Cuando se hace click en el botón de Consulta, recargar la lista
document.querySelector('.menu-btn[onclick="mostrarSeccion(\'consulta\', this)"]').addEventListener('click', () => {
    setTimeout(() => {
        consultarTodos();
    }, 100);
});
